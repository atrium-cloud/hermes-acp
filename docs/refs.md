...
- `session/fork` is a first-class experimental method (still experimental in SDK 1.5.0, schema v1.23.0); this adapter implements head-only fork, with no breakpoint marker advertised (docs/todos.md section 2).
